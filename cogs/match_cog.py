...
class MatchCog(commands.Cog):
    ...
    async def on_drs_match_formed(self, match_id: int, drs_level: int, participants: list[dict]):
        logger.info(f"Match {match_id} formed — DRS{drs_level} — players: {[p['display_name'] for p in participants]}")
        ...
        self.bot.dispatch("drs_create_threads", match_id, drs_level, full_participants)
